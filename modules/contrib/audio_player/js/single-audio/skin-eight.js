(function ($, Drupal, drupalSettings) {
  ...
  Drupal.behaviors.audio_player_skin_eight = {
    attach: function (context, settings) {
      // Use once to ensure the script runs only once per element.
      once('audio_player_skin_eight', '.audio-player.skin-eight', context).forEach(function (playerElement) {
        ...
        $progressContainer.on('mousedown', (e) => {
          ...
          const clickX = e.offsetX; // jQuery's event object has offsetX directly
